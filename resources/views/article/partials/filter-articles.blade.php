@can('manage')
    ...
    <div class="px-3 py-2 mr-3 my-4 border round-md">
        <div x-data="{
            filters: [
                'is_featured', 'is_translate_designated', 'is_popular',
                'is_auto_translated', 'is_edited', 'is_published'
                ],
            is_featured: false,
...
{{--                    console.log(filter, that[filter], filterValue);--}}
            ...
            <div class="flex items-center ml-4">
                ...
                <label for="is_featured" class="ml-3 font-medium text-gray-900">مقالات ویژه</label>
            </div>
            ...
            <div class="flex items-center ml-4">
                ...
                <label for="is_translate_designated" class="ml-3 font-medium text-gray-900">منتخب ترجمه</label>
            </div>
            ...
            <div class="flex items-center ml-4">
                ...
                <label for="is_popular" class="ml-3 font-medium text-gray-900">پر بازدید</label>
            </div>
            ...
            <div class="flex items-center ml-4">
                ...
                <label for="is_auto_translated" class="ml-3 font-medium text-gray-900">ترجمه اتوماتیک شده</label>
            </div>
            ...
            <div class="flex items-center ml-4">
                ...
                <label for="is_edited" class="ml-3 font-medium text-gray-900">ویرایش شده</label>
            </div>

            <div class="flex items-center ml-4">
                <input x-model="is_published" id="is_published" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                <label for="is_published" class="ml-3 font-medium text-gray-900">منتشر شده</label>
            </div>

            <button @click="doFilter()" type="button" class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2 ml-3">برو</button>
