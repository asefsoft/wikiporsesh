...
abstract class ArticleDetail {
    // html source of article page
    protected mixed $htmlSource;
    ...
    // all info of article found on page including download links, resolutions ...
    protected Collection|array $articleInfo;
    protected Collection|array $articleSections = [];
    ...
    protected bool $articleSectionFound = false;

    protected array $stepsVideos = [];
    protected array $otherVideos = [];

    protected array $errorMessages = [];

    // in some cases we invalidate some articles
    ...
    public function __construct($htmlSource, $sourceUrl) {
        $this->htmlSource          = $htmlSource;
        $this->sourceUrl           = $sourceUrl;
        $this->domCrawler          = new DomCrawler($this->htmlSource, new Uri($this->sourceUrl));
        $this->parseArticleInfo();
        $this->escapeMustache();
    }

    abstract public function parseArticleInfo() : bool;
    abstract public function isReadyToBeSaved() : bool;
    ...
    public function isArticleInfoFound() : bool {
        return $this->articleInfoFound;
    }

    public function getArticleInfo() : Collection {
        return $this->articleInfoFound ? $this->articleInfo : collect();
    }
    ...
    public function getArticleTips() : string {
        return $this->articleTips;
    }

    public function getArticleWarnings() : string {
        return $this->articleWarnings;
    }

    public function isArticleSectionFound() : bool {
        return $this->articleSectionFound;
    }
    ...
    public function isFeaturedArticle() : bool {
        return $this->isFeaturedArticle;
    }

    public function hasLdJsonData() : bool {
        return $this->hasLdJsonData;
    }

    public function getStepsVideos() : array {
        return $this->stepsVideos;
    }

    public function getOtherVideos() : array {
    ...
    public function getArticleSections() : array|Collection {
        return $this->articleSections;
    }

    public function getTotalArticleSections() : int {
        return count($this->articleSections);
    }

    public function getArticleSteps() : array|Collection {
        return $this->articleSteps;
    }
    ...
    public function setStepVideoItem(array $videoInfo, $index) {
        $this->stepsVideos[$index] = $videoInfo;
    }
